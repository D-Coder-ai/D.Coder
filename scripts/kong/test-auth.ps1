...
try {
    ...
    if ($_.Exception.Response.StatusCode.value__ -eq 404) {
        ...
        Write-Host "Start Kong with: docker-compose -f gateway/docker-compose.yml up -d" -ForegroundColor Yellow
        exit 1
    }
}
...
if ($missingKeys.Count -eq 4) {
    ...
    Write-Host "See gateway/API_KEYS.md for setup instructions" -ForegroundColor Yellow
