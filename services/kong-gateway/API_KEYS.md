...
1. **Copy the template file:**
   ```bash
   # Linux/Mac
   cp platform/gateways/kong/env.template platform/gateways/kong/.env
...
3. **Verify setup:**
   ...
   source platform/gateways/kong/.env
...
Alternatively, create a `.env` file manually in the `platform/gateways/kong/` directory:
